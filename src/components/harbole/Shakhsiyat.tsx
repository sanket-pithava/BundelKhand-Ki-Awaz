  ...
  return (
    <section className="py-10">
      <div className="px-4 mb-5">
        ...
        <h2 className="font-hindi text-2xl font-semibold text-navy leading-none">
          शख्सियत
        </h2>
        <p className="text-navy/50 text-xs font-body-hindi mt-2">
          वो चेहरे जिनकी कहानियाँ बुंदेलखंड को आकार दे रही हैं
        </p>
      </div>
        ...
        {profiles.map((p) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5">
              <p className="font-hindi text-paper text-lg leading-snug text-balance mb-3">
                "{p.quote}"
              </p>
