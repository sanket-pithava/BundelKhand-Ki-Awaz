...
const RESOURCES: Resource[] = [
  {
    ...
    fields: [
      ...
      { key: "image_url", label: "Cover Image (Desktop - 1920x800)", type: "image" },
      { key: "mobile_image_url", label: "Cover Image (Mobile - 1080x1350)", type: "image" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "slug", label: "Slug (unique)", type: "text", placeholder: "e.g. atal-bihari-vajpayee" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "image_url", label: "Desktop Banner Image (1920x800)", type: "image" },
      { key: "mobile_image_url", label: "Mobile Banner Image (1080x1350)", type: "image" },
